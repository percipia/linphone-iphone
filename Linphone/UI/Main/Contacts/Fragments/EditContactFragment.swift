			...
			VStack(spacing: 1) {
				...
				HStack {
					...
					Image("check")
						.renderingMode(.template)
						.resizable()
						.foregroundStyle(editContactViewModel.firstName.isEmpty ? Color.percipiaGreen : Color.percipiaGreen)
						.frame(width: 25, height: 25, alignment: .leading)
						.padding(.all, 10)
						.padding(.top, 2)
								...
								TextField("contact_editor_first_name", text: $editContactViewModel.firstName)
									...
									.overlay(
										RoundedRectangle(cornerRadius: 60)
											.inset(by: 0.5)
											.stroke(isFirstNameFocused ? Color.percipiaGreen : Color.gray200, lineWidth: 1)
									)
									.padding(.bottom)
							...
							VStack(alignment: .leading) {
								...
								TextField("contact_editor_last_name", text: $editContactViewModel.lastName)
									...
									.overlay(
										RoundedRectangle(cornerRadius: 60)
											.inset(by: 0.5)
											.stroke(isLastNameFocused ? Color.percipiaGreen : Color.gray200, lineWidth: 1)
									)
									.padding(.bottom)
									...
									HStack(alignment: .center) {
										TextField("sip_address", text: $editContactViewModel.sipAddresses[index])
											...
											.overlay(
												RoundedRectangle(cornerRadius: 60)
													.inset(by: 0.5)
													.stroke(isSIPAddressFocused == index ? Color.percipiaGreen : Color.gray200, lineWidth: 1)
											)
									...
									HStack(alignment: .center) {
										TextField("phone_number", text: $editContactViewModel.phoneNumbers[index])
											...
											.overlay(
												RoundedRectangle(cornerRadius: 60)
													.inset(by: 0.5)
													.stroke(isPhoneNumberFocused == index ? Color.percipiaGreen : Color.gray200, lineWidth: 1)
											)
							...
							VStack(alignment: .leading) {
								...
								TextField("contact_editor_company", text: $editContactViewModel.company)
									...
									.overlay(
										RoundedRectangle(cornerRadius: 60)
											.inset(by: 0.5)
											.stroke(isCompanyFocused ? Color.percipiaGreen : Color.gray200, lineWidth: 1)
									)
									.padding(.bottom)
							...
							VStack(alignment: .leading) {
								...
								TextField("contact_editor_job_title", text: $editContactViewModel.jobTitle)
									...
									.overlay(
										RoundedRectangle(cornerRadius: 60)
											.inset(by: 0.5)
											.stroke(isJobTitleFocused ? Color.percipiaGreen : Color.gray200, lineWidth: 1)
									)
									.padding(.bottom)
