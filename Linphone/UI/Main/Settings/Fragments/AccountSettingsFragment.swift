										...
										TextField("account_settings_voicemail_uri_title", text: $accountSettingsViewModel.voicemailUri)
											...
											.overlay(
												RoundedRectangle(cornerRadius: 60)
													.inset(by: 0.5)
													.stroke(isVoicemailUriFocused ? Color.percipiaGreen : Color.gray200, lineWidth: 1)
											)
									...
									VStack(alignment: .leading) {
										...
										TextField("account_settings_mwi_uri_title", text: $accountSettingsViewModel.mwiUri)
											...
											.overlay(
												RoundedRectangle(cornerRadius: 60)
													.inset(by: 0.5)
													.stroke(isMwiUriFocused ? Color.percipiaGreen : Color.gray200, lineWidth: 1)
											)
										...
										VStack(spacing: 30) {
											VStack(alignment: .leading) {
												...
												TextField("account_settings_stun_server_url_title", text: $accountSettingsViewModel.stunServerUrl)
													...
													.overlay(
														RoundedRectangle(cornerRadius: 60)
															.inset(by: 0.5)
															.stroke(isStunServerUriFocused ? Color.percipiaGreen : Color.gray200, lineWidth: 1)
													)
											...
											VStack(alignment: .leading) {
												...
												TextField("account_settings_turn_username_title", text: $accountSettingsViewModel.turnUsername)
													...
													.overlay(
														RoundedRectangle(cornerRadius: 60)
															.inset(by: 0.5)
															.stroke(isTurnUsernameFocused ? Color.percipiaGreen : Color.gray200, lineWidth: 1)
													)
											...
											VStack(alignment: .leading) {
												...
												.overlay(
													RoundedRectangle(cornerRadius: 60)
														.inset(by: 0.5)
														.stroke(isTurnPasswordFocused ? Color.percipiaGreen : Color.gray200, lineWidth: 1)
												)
												.padding(.bottom)
											}
										}
											...
											VStack(alignment: .leading) {
												...
												TextField("account_settings_sip_proxy_url_title", text: $accountSettingsViewModel.sipProxyUrl)
													...
													.overlay(
														RoundedRectangle(cornerRadius: 60)
															.inset(by: 0.5)
															.stroke(isSipProxyUrlFocused ? Color.percipiaGreen : Color.gray200, lineWidth: 1)
													)
											...
											VStack(alignment: .leading) {
												...
												TextField("account_settings_expire_title", text: $accountSettingsViewModel.expire)
													...
													.overlay(
														RoundedRectangle(cornerRadius: 60)
															.inset(by: 0.5)
															.stroke(isSettingsExpireFocused ? Color.percipiaGreen : Color.gray200, lineWidth: 1)
													)
											...
											VStack(alignment: .leading) {
												...
												TextField("account_settings_conference_factory_uri_title", text: $accountSettingsViewModel.conferenceFactoryUri)
													...
													.overlay(
														RoundedRectangle(cornerRadius: 60)
															.inset(by: 0.5)
															.stroke(isConferenceFactoryUriFocused ? Color.percipiaGreen : Color.gray200, lineWidth: 1)
													)
											...
											VStack(alignment: .leading) {
												...
												TextField("account_settings_audio_video_conference_factory_uri_title", text: $accountSettingsViewModel.audioVideoConferenceFactoryUri)
													...
													.overlay(
														RoundedRectangle(cornerRadius: 60)
															.inset(by: 0.5)
															.stroke(isAudioVideoConferenceFactoryUriFocused ? Color.percipiaGreen : Color.gray200, lineWidth: 1)
													)
											...
											VStack(alignment: .leading) {
												...
												TextField("account_settings_ccmp_server_url_title", text: $accountSettingsViewModel.ccmpServerUrl)
													...
													.overlay(
														RoundedRectangle(cornerRadius: 60)
															.inset(by: 0.5)
															.stroke(isCcmpServerUrlFocused ? Color.percipiaGreen : Color.gray200, lineWidth: 1)
													)
											...
											VStack(alignment: .leading) {
												...
												TextField("account_settings_lime_server_url_title", text: $accountSettingsViewModel.limeServerUrl)
													...
													.overlay(
														RoundedRectangle(cornerRadius: 60)
															.inset(by: 0.5)
															.stroke(isLimeServerUrlFocused ? Color.percipiaGreen : Color.gray200, lineWidth: 1)
													)
