					...
					VStack(spacing: 0) {
						VStack(spacing: 30) {
							...
							VStack(alignment: .leading) {
								...
								TextField("settings_advanced_device_id_hint", text: $settingsViewModel.deviceId)
									...
									.overlay(
										RoundedRectangle(cornerRadius: 60)
											.inset(by: 0.5)
											.stroke(isDeviceIdFocused ? Color.percipiaGreen : Color.gray200, lineWidth: 1)
									)
							...
							VStack(alignment: .leading) {
								...
								TextField("settings_advanced_upload_server_url", text: $settingsViewModel.uploadServerUrl)
									...
									.overlay(
										RoundedRectangle(cornerRadius: 60)
											.inset(by: 0.5)
											.stroke(isUploadServerUrlFocused ? Color.percipiaGreen : Color.gray200, lineWidth: 1)
									)
							...
							VStack(alignment: .leading) {
								...
								TextField("settings_advanced_remote_provisioning_url", text: $settingsViewModel.remoteProvisioningUrl)
									...
									.overlay(
										RoundedRectangle(cornerRadius: 60)
											.inset(by: 0.5)
											.stroke(isRemoteProvisioningUrlFocused ? Color.percipiaGreen : Color.gray200, lineWidth: 1)
									)
							...
							HStack {
								...
								.padding(.horizontal, 20)
								.padding(.vertical, 10)
								.background(settingsViewModel.remoteProvisioningUrl.isEmpty ? Color.percipiaGreen : Color.percipiaGreen)
								.cornerRadius(60)
