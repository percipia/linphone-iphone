...
class ThemeManager {
	...
	init () {
		...
		currentTheme = themes[storedName ?? ""] ?? ThemeManager.percipia
	}
	...
	static let percipia = Theme(
		name: "percipia",
		main100: Color(hex: "#E6F4EA"),
		main100Alpha50: Color(hex: "#80E6F4EA"),
		main300: Color(hex: "#99E0B3"),
		main500: Color(hex: "#33CC66"),
		main700: Color(hex: "#26994D")
	)
